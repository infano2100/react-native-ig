...
class EditProfile extends Component {
  ...
  onUploadImage = (uri, mime = 'application/octet-stream') => {
  ...
  render() {
    return (
      <View style={styles.container}>
        <Header title="Edit profile" onNext={this.onSaveChanges} onCancel={this.cancelEdit} />
        <ScrollView>
